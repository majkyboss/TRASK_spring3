...
INSERT INTO `spring3`.`User` (`birth_date`, `date_in`, `date_out`, `degree`, `lastname`, `name`, `role_id`, `password_hash`, `username`, `enabled`) VALUES ('1111118888', '1111-11-11', '2222-11-11', 'Bc', 'lastName1', 'user1', '1', '$2a$10$ekcUs5358Nq5XEHysqzEg.vXYGe7EXsIC85K/fusijfUR9oWafPH.', 'user1', true); 
...
INSERT INTO `spring3`.`User` (`birth_date`, `date_in`, `degree`, `lastname`, `name`, `role_id`, `password_hash`, `username`, `enabled`) VALUES ('0611898661', '2015-07-01', 'Bc', 'Banik', 'Michal', '1', '$2a$10$ozlQerA9PY3.YNowgaKRF.TQU0M95qHk4MTVy008s2TDSlYSpMi1a', 'majky', true);
